...
const BounceIn = styled.div`
  animation: 2s ${keyframes`${bouceIn}`} infinite;
`;
const BouceOut = styled.div`
  animation: 2s ${keyframes`${bouceOut}`} infinite;
`;
const BounceInDown = styled.div`
  animation: 2s ${keyframes`${bounceInDown}`} infinite;
`;
const BounceInLeft = styled.div`
  animation: 2s ${keyframes`${bounceInLeft}`} infinite;
`;
const BounceInRight = styled.div`
  animation: 2s ${keyframes`${bounceInRight}`} infinite;
`;
const BounceInUp = styled.div`
  animation: 2s ${keyframes`${bounceInUp}`} infinite;
`;
const BounceOutDown = styled.div`
  animation: 2s ${keyframes`${bounceOutDown}`} infinite;
`;
const BounceOutLeft = styled.div`
  animation: 2s ${keyframes`${bounceOutLeft}`} infinite;
`;
const BounceOutRight = styled.div`
  animation: 2s ${keyframes`${bounceOutRight}`} infinite;
`;
const BounceOutUp = styled.div`
  animation: 2s ${keyframes`${bounceOutUp}`} infinite;
`;
const FadeIn = styled.div`
  animation: 2s ${keyframes`${fadeIn}`} infinite;
`;
const FadeInDown = styled.div`
  animation: 2s ${keyframes`${fadeInDown}`} infinite;
`;
const FadeInDownBig = styled.div`
  animation: 2s ${keyframes`${fadeInDownBig}`} infinite;
`;
const FadeInLeft = styled.div`
  animation: 2s ${keyframes`${fadeInLeft}`} infinite;
`;
const FadeInLeftBig = styled.div`
  animation: 2s ${keyframes`${fadeInLeftBig}`} infinite;
`;
const FadeInRight = styled.div`
  animation: 2s ${keyframes`${fadeInRight}`} infinite;
`;
const FadeInRightBig = styled.div`
  animation: 2s ${keyframes`${fadeInRightBig}`} infinite;
`;
const FadeInUp = styled.div`
  animation: 2s ${keyframes`${fadeInUp}`} infinite;
`;
const FadeInUpBig = styled.div`
  animation: 2s ${keyframes`${fadeInUpBig}`} infinite;
`;
const FadeOut = styled.div`
  animation: 2s ${keyframes`${fadeOut}`} infinite;
`;
const FadeOutDown = styled.div`
  animation: 2s ${keyframes`${fadeOutDown}`} infinite;
`;
const FadeOutDownBig = styled.div`
  animation: 2s ${keyframes`${fadeOutDownBig}`} infinite;
`;
const FadeOutLeft = styled.div`
  animation: 2s ${keyframes`${fadeOutLeft}`} infinite;
`;
const FadeOutLeftBig = styled.div`
  animation: 2s ${keyframes`${fadeOutLeftBig}`} infinite;
`;
const FadeOutRight = styled.div`
  animation: 2s ${keyframes`${fadeOutRight}`} infinite;
`;
const FadeOutRightBig = styled.div`
  animation: 2s ${keyframes`${fadeOutRightBig}`} infinite;
`;
const FadeOutUp = styled.div`
  animation: 2s ${keyframes`${fadeOutUp}`} infinite;
`;
const FadeOutUpBig = styled.div`
  animation: 2s ${keyframes`${fadeOutUpBig}`} infinite;
`;
...
const FlipInY = styled.div`
  animation: 2s ${keyframes`${flipInY}`} infinite;
`;
const FlipOutX = styled.div`
  animation: 2s ${keyframes`${flipOutX}`} infinite;
`;
const FlipOutY = styled.div`
  animation: 2s ${keyframes`${flipOutY}`} infinite;
`;
...
const Jello = styled.div`
  animation: 2s ${keyframes`${jello}`} infinite;
`;
const LightSpeedIn = styled.div`
  animation: 2s ${keyframes`${lightSpeedIn}`} infinite;
`;
const LightSpeedOut = styled.div`
  animation: 2s ${keyframes`${lightSpeedOut}`} infinite;
`;
...
const RollOut = styled.div`
  animation: 2s ${keyframes`${rollOut}`} infinite;
`;
const RotateIn = styled.div`
  animation: 2s ${keyframes`${rotateIn}`} infinite;
`;
const RotateInDownLeft = styled.div`
  animation: 2s ${keyframes`${rotateInDownLeft}`} infinite;
`;
const RotateInDownRight = styled.div`
  animation: 2s ${keyframes`${rotateInDownRight}`} infinite;
`;
const RotateInUpLeft = styled.div`
  animation: 2s ${keyframes`${rotateInUpLeft}`} infinite;
`;
const RotateInUpRight = styled.div`
  animation: 2s ${keyframes`${rotateInUpRight}`} infinite;
`;
const RotateOut = styled.div`
  animation: 2s ${keyframes`${rotateOut}`} infinite;
`;
const RotateOutDownLeft = styled.div`
  animation: 2s ${keyframes`${rotateOutDownLeft}`} infinite;
`;
const RotateOutDownRight = styled.div`
  animation: 2s ${keyframes`${rotateOutDownRight}`} infinite;
`;
const RotateOutUpLeft = styled.div`
  animation: 2s ${keyframes`${rotateOutUpLeft}`} infinite;
`;
const RotateOutUpRight = styled.div`
  animation: 2s ${keyframes`${rotateOutUpRight}`} infinite;
`;
...
const SlideInDown = styled.div`
  animation: 2s ${keyframes`${slideInDown}`} infinite;
`;
...
const SlideInUp = styled.div`
  animation: 2s ${keyframes`${slideInUp}`} infinite;
`;
const SlideOutDown = styled.div`
  animation: 2s ${keyframes`${slideOutDown}`} infinite;
`;
const SlideOutLeft = styled.div`
  animation: 2s ${keyframes`${slideOutLeft}`} infinite;
`;
const SlideOutRight = styled.div`
  animation: 2s ${keyframes`${slideOutRight}`} infinite;
`;
const SlideOutUp = styled.div`
  animation: 2s ${keyframes`${slideOutUp}`} infinite;
`;
...
const ZoomInDown = styled.div`
  animation: 2s ${keyframes`${zoomInDown}`} infinite;
`;
const ZoomInLeft = styled.div`
  animation: 2s ${keyframes`${zoomInLeft}`} infinite;
`;
const ZoomInRight = styled.div`
  animation: 2s ${keyframes`${zoomInRight}`} infinite;
`;
const ZoomInUp = styled.div`
  animation: 2s ${keyframes`${zoomInUp}`} infinite;
`;
const ZoomOut = styled.div`
  animation: 2s ${keyframes`${zoomOut}`} infinite;
`;
const ZoomOutDown = styled.div`
  animation: 2s ${keyframes`${zoomOutDown}`} infinite;
`;
const ZoomOutLeft = styled.div`
  animation: 2s ${keyframes`${zoomOutLeft}`} infinite;
`;
const ZoomOutRight = styled.div`
  animation: 2s ${keyframes`${zoomOutRight}`} infinite;
`;
const ZoomOutUp = styled.div`
  animation: 2s ${keyframes`${zoomOutUp}`} infinite;
`;
